...
| Execution             | Coherent buyer page, separate phone host, camera and no-permission paths, privacy receipts, exact hold, exact UCP Cart, cancellation, reset, and preflight.                      | Revisioned/reconnect-safe Durable Objects; idempotency; strict TypeScript; 108 deterministic tests; two Worker dry-runs; production build; atomic commit verifier.   | Stable unprotected URLs, clean public clone, external comprehension test, and physical phone/item pass. |
