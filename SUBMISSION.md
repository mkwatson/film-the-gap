...
- Strict TypeScript, formatting, linting, 207 application/Workerd tests, Worker dry runs, and an eight-route Next.js production build pass on the current branch and from an exact frozen-install clone of `81a405ca991ae27704c06b78f0a0927c6b0e23f5`.
