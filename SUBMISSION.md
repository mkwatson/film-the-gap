...
- Strict TypeScript, formatting, linting, 214 application/Workerd tests, Worker dry runs, and an eight-route Next.js production build pass on the current branch and from an exact frozen-install clone of `fcede7cb81e69491612cf78867671b78e71728cb`.
