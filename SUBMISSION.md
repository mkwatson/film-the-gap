...
- Strict TypeScript, formatting, linting, all 220 application/Workerd tests, the Worker dry run, and the eight-route Next.js production build pass on the current cut-aware branch. The immediate pre-segmentation fallback `fcede7cb81e69491612cf78867671b78e71728cb` separately passed an exact frozen-install clone gate.
