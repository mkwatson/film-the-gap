...
- [x] Public repository contains all code, authored assets, exact setup instructions, and challenge-period history; an anonymous cold clone passes the complete gate.
- [x] Direct `document.modelContext.registerTool` usage is easy to find from the README.
- [x] Public generic live URL is free and unprotected; it is configured to remain stable through the judging period.
