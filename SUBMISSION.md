...
| Execution             | Coherent buyer page, separate phone host, camera and no-permission paths, privacy receipts, exact hold, exact UCP Cart, cancellation, reset, and preflight.                      | Keyed tool lifecycle; stale-handle/reload recovery; Durable Objects; idempotency; strict TypeScript; 120 deterministic tests; proof replay; two Worker dry-runs; production build.  | Stable unprotected URLs, clean public clone, external comprehension test, and physical phone/item pass. |
