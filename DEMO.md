...
| `1:48–2:03` | Use a mapped timestamp to scrub the recording; review or correct every material field, choose separate publishing rights and reuse, then check the final human confirmation and publish.                       | “The contributor inspects the actual recording, corrects the AI, deliberately chooses publishing rights, and explicitly confirms the final evidence.”                                              |
...
| `2:18–2:48` | Return to the original `/demo-product`. Its missing-proof card is now the green reviewed result; invoke its replacement inspection tool, then open the timestamped citation for one beat on the signed viewer. | “Now the original product page has learned a fact its marketing copy could never prove. The raw video is private, but any shopper can verify this cited moment through temporary signed playback.” |
