...
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `0:00–0:10` | Owned bottle beside the page. Highlight the question, marketing-copy source, and **Not enough proof** answer.                                                                      | “This bottle says leak resistant. That does not prove it stays dry upside down for ten seconds—the question I actually care about.”                                         |
| `0:10–0:27` | Send the primary prompt. ChatGPT inspects the case and calls native **Search existing product evidence**. Show that public results remain leads and the answer stays insufficient. | “Site Tools search reviewed network evidence, product pages, public video, and the open web—but ordinary links are not automatically proof.”                                |
...
6. **Completed-mission fallback and fresh-shopper reuse:** after the real mission is published with reuse consent, open the exact same product URL and question in a new case, search, and capture the same Stream UID/timestamp resolving it with no mission creation. This is an honest replay of the earlier recording, not a new person, model call, or physical test.
