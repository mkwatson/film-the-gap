...
| App tests                     | 29 files, 180 tests pass                           | Product state, strict page handoff, product-page tool replacement, privacy, review, search, page-reading boundaries, reconnect, failures, and release checks.                 |
