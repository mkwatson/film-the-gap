...
Keep the current product and sharpen its causal proof. Do not compete on “evidence,” “human approval,” commerce search, tool count, or sponsor count by themselves; those patterns are already crowded.

The differentiating loop to own is:

```text
an agent reaches an honest evidence gap
  → WebMCP creates the smallest observable filming job
  → a separate person with the physical product finds it
...
- Search recall, private repositories, unindexed pages, late submissions, duplicate experiments, and changing projects prevent any exhaustive novelty conclusion.

## Strong public archetypes

| Archetype                     | Representative public examples                                                                                                                                                                                                                         | What is already crowded                                                                                                          | Implication for Film the Gap                                                                                                                   |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| Evidence/decision workspace   | [ProofRoom](https://github.com/0xTrey/proofroom-webmcp), [Proofboard](https://github.com/lsh2546/proofboard-webmcp), [ProofRail](https://github.com/monkeyhut/proofrail-webmcp), [NetSpectre](https://github.com/DoobyDev/NetSpectre-WebMCP-Challenge) | Agents inspect evidence or drafts; humans approve consequential conclusions; revisions and receipts are visible.                 | Never pitch merely “AI proposes, human approves.” Show that the agent causes missing evidence to be created by another person.                 |
| Agentic commerce              | [BasketShipper](https://github.com/Timtech4u/groundedrelay-webmcp), [Agentic WebMCP](https://github.com/Somnora/agentic-webmcp), [GeoMart](https://github.com/dannwaneri/geomart-webmcp), [GoGoCash](https://github.com/mygogocash/gogocash-webmcp)    | Search, compare, product fit, basket mutation, merchant handoff, and private page state are common.                              | Commerce should remain a future consequence, not the hero. The submission must create information that catalogs and product pages do not have. |
| Human-gated reversible action | [Rehearse](https://github.com/LubuSeb/rehearse), [Ladder](https://github.com/harshpuri84/ladder-webmcp), [Latchline](https://github.com/DominiqueAndrew/latchline-webmcp)                                                                              | Visible proposals, stale-state rejection, exact approval, rollback, and hashes are becoming baseline signs of careful execution. | Keep our strict state frontier and confirmation gates, but spend demo time on the cross-person physical event and answer change.               |
| Tooling/bridges               | [WebMCP Bridge](https://github.com/Wisteria30/webmcp-bridge), [Glippy](https://github.com/jbobbink/glippy-webmcp), [Citability WebMCP Lab](https://github.com/Citability/webmcp-lab)                                                                   | Tool generation, projection, debugging, benchmarking, and portability are separate platform plays.                               | Do not turn the product into WebMCP middleware. Use direct, inspectable native tools and let the application outcome carry the story.          |

## What judges must see—not merely read

1. The source page visibly makes a marketing claim, while the answer honestly remains insufficient.
2. Native Site Tools search first and then change with the lifecycle; the mission action is not permanently available CRUD.
3. The request crosses to a genuinely separate public board and ordinary phone page, without a merchant integration, user account, or hidden customer list.
