...
- The UCP Cart client, Durable Object credential boundary, dynamic Site Tools, human receipt UI, cancellation, and private-result purge pass against both a live public Shopify integration control and a labeled local HTTPS fixture. Neither is the final merchant: the judged path still needs an owned public Shopify product with cleared media and immediate-cancel acceptance. Checkout completion is not part of the hero flow.
