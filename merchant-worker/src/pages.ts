...
export function renderMerchantHome(origin: string, nonce: string): string {
  ...
  const content = `
    ...
    <section class="hero">
      ...
      <div class="panel" role="img" aria-label="${escapeHtml(demoProduct.title)}">
...
export function renderContinuation(
  ...
  const content = `
    ...
    <section class="receipt">
      ...
      <div class="card" role="region" aria-label="Merchant cart receipt">
