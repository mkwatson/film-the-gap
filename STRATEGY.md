...
| ---------------------------------------------------------- | ------------------: | --------------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Stable public buyer, room, and merchant origins            |           Very high |              No | Keep the exact deploy/verify/rollback command ready. MIT is approved; do not substitute another feature for repository publication and vendor-authorization actions.   |
